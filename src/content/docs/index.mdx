...
hero:
  tagline: "Aquí encontrarás todo lo que necesitas para aprender a crear páginas web con HTML, CSS, desde cero."
  image:
    file: ../../assets/houston.webp
  actions:
    - text: Introducción a la web
      link: /introduccion/introduccion-web/
      icon: right-arrow
---
{/*
